...
vmap <silent> gcs :call CountSpaces(visualmode(), 1)
...
set cmdheight=3
set cmdwinheight=3
set comments=s1:/*,mb:*,ex:*/,://,b:#,:%,:XCOMM,n:>,fb:-,b:-,n:*,n:#,s2:/*,:\\begin{,:\\end{,:\\title{,:\\author{,:\\subtitle{,:\\part{,:\\chapter{,:\\section{,:\\subsection{,:\\subsubsection{,:\\paragraph,:\\subparagraph{,:\\usepackage{,:\\documenclass{,:\\usepackage[,:#
set commentstring=#\ %s
...
set shortmess=aoO
badd +0 imgckWatermark
argglobal
silent! argdel *
argadd imgckWatermark
edit imgckWatermark
